...
public class Quiz5Activity extends AppCompatActivity {
    ...
    private void checkAnswers() {
        if (radioGroup1.getCheckedRadioButtonId() == -1 ||
            ...
            boolean res = DB.insertScore(Integer.parseInt(UserID),5, score);
            if (res) {
                Toast.makeText(Quiz5Activity.this, "ได้คะแนนทั้งหมด : " + score + " คะแนน", Toast.LENGTH_LONG).show();
                Toast.makeText(Quiz5Activity.this, message, Toast.LENGTH_LONG).show();
            } else {
                Toast.makeText(Quiz5Activity.this, "เกิดข้อผิดพลาด", Toast.LENGTH_LONG).show();
            }
        }
    }
}
